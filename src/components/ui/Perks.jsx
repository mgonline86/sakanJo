...
const Perks = ({ selected, handleFormData  , formData}) => {
  ...
  return (
    <div className="mt-2 grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-6">
      ...
      <label className="flex cursor-pointer items-center gap-2 rounded-2xl border p-4">
        <input
          type="checkbox"
          checked={selected.includes('equipped')}
          name="equipped"
          onChange={handleFormData}
        />
      ...
      <label className="flex cursor-pointer items-center gap-2 rounded-2xl border p-4">
        <input
          type="checkbox"
          checked={selected.includes('floors')}
          name="floors"
          onChange={handleFormData}
        />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
      ...
      >
        <input
          type="checkbox"
          checked={selected.includes('planted')}
          name="planted"
          onChange={handleFormData}
        />
      ...
      <label className="flex cursor-pointer items-center gap-2 rounded-2xl border p-4">
        ...
        <span>It contains water</span>
      </label>
      <label className="flex cursor-pointer items-center gap-2 rounded-2xl border p-4">
        <input
          type="checkbox"
          checked={selected.includes('electricity')}
          name="electricity"
          onChange={handleFormData}
        />
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    />
        ...
        <span>It has a swimming pool</span>
      </label>
      <label className="flex cursor-pointer items-center gap-2 rounded-2xl border p-4">
        <input
          type="checkbox"
        ...
        <span>It has a fence</span>
      </label>
      <label className="flex cursor-pointer items-center gap-2 rounded-2xl border p-4">
        <input
          type="checkbox"
          checked={selected.includes('cultivable')}
          name="cultivable"
          onChange={handleFormData}
        />
       <svg width="32" height="32" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
