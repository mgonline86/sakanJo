  ...
  return (
    <div className="flex w-full justify-center bg-gray-100 pb-8">
      <div className="flex w-full max-w-screen-xl flex-col items-center px-6">
        {/* grid for links */}
        <div className="grid w-full grid-cols-1 gap-x-16 gap-y-4 py-8 text-sm md:grid-cols-3">
        ...
        <div className="flex w-full flex-col items-center justify-between gap-4 md:gap-0 lg:flex-row">
          <div className="mt-4 flex w-full flex-wrap justify-between gap-10 md:order-last md:w-auto">
            <div className="flex items-center text-sm font-semibold">
              ...
              >
                <p style={isArabic ? { color: 'black' } : { color: '#467d9e' }}>
                  English
                </p>{' '}
              </button>
              <button
              ...
              >
                <p
                  style={!isArabic ? { color: 'black' } : { color: '#467d9e' }}
                >
                  Arabic
                </p>
              </button>
            ...
            <div className="flex gap-3">
              ...
              >
                <Facebook className="transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Twitter className="transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Instagram className="transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <LinkedIn className="transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
              </a>
            </div>
          </div>
